...
export const Key = ({ key, isPressed }: IProps) => {
  switch (key) {
    case "C3":
      return (
        <g
          id="C3"
          className={classNames("synth-key", "white", { isPressed: "pressed" })}
          transform="translate(2.000000, 2.000000)"
        >
          <rect x="0" y="0" width="24" height="82" className="crack"></rect>
          <path
