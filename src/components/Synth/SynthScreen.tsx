...
export const SynthScreen = ({
  ...
  return (
    <g id="synth-screen" transform="translate(24.000000, 4.000000)">
      ...
      {isSynthActive && (
        <g
          className={styles.synthInstruments}
      ...
      {isSynthActive && (
        ...
        >
          ...
          <g transform="translate(32.000000, 4.000000)">
            <path
