...
interface SynthScreenProps {
  ...
  onFirstClick: (e: React.MouseEvent<SVGGElement>) => void;
...
export const SynthScreen = ({
  ...
  return (
    <g
      ...
      onClick={!isSynthActive ? onFirstClick : undefined}
    >
      <rect
        className={styles.lcdOutline}
        x="0"
        y="0"
        width="222"
        height="52"
      ...
      {isSynthActive && (
        <g transform="translate(108.000000, 6.000000)">
          <g
            className={styles.instrumentArrow}
            fillRule="nonzero"
            onClick={onClickPrev}
          >
          ...
          <g
            className={styles.synthInstrument}
          ...
          >
            ...
            <g
              ...
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 0,
              })}
            ...
            <g
              id="harp"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 1,
              })}
            ...
            <g
              id="xylophone"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 2,
              })}
            ...
            <g
              id="banjo"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 3,
              })}
            ...
            <g
              id="ocarina"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 4,
              })}
            ...
            <g
              id="mouth"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 5,
              })}
            ...
            <g
              id="butt"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 6,
              })}
              transform="translate(3.000000, 4.000000)"
            >
              <path
            ...
            <g
              id="block"
              className={classNames(styles.instrument, {
                [styles.visible]: activeInstrument === 7,
              })}
            ...
            {!isSynthLoading && (
              <g
                id="die"
                className={styles.synthRandomize}
                transform="translate(4.000000, 0.000000)"
              >
                <path
