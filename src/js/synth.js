...
var synth = (function () {
  ...
  // Cache DOM ---------------------------------------------------//
  var synth, keys, instrumentIcons, instrumentIconWrapper, noteheads, keyLetters, prevArrow, nextArrow
  ...
  function _bindEvents () {
    ...
    Array.from(instrumentIcons).forEach(icon => {
      icon.addEventListener('hover', handleIconHover)
    })
  ...
  function _unbindEvents () {
    ...
    Array.from(instrumentIcons).forEach(icon => {
      icon.removeEventListener('hover', handleIconHover)
    })
