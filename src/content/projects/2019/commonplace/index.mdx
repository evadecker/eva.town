...
Create a new `Button`, test it, swap out all existing buttons and delete all existing styles. Now onto `Input`. Rinse and repeat. This took place over the course of many months, alongside other feature work I was involved in, and it took place largely independently, although I continued to collaborate with Neves for visual and interaction design feedback, and engineers like [Brennan](https://www.zamiang.com/), [Craig](http://www.craigspaeth.com/), and [Aster](https://aster.fyi/) for code review.
