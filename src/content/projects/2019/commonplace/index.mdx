...
Care teams at Cityblock are given small Chromebooks to take with them around the city. They use their Chromebook to access Commons in many locations, like the office, at community hubs, in members' homes, and in their car or on the subway.
...
Then began the long and steady process of building and replacing components one-by-one. Create a new `Button`. Test it. Swap out all existing buttons and delete all existing styles. Merge in the changes. Pick a new component, then rinse and repeat.
...
<figure>
  ![The member table in Commons after the introduction of
  Commonplace.](./member-table-after.png)(quality:100)
  <figcaption>
    **After.** The member table, early 2020. Still data-dense, but easier to
    scan. Truncated table cells display a tooltip on hover.
  </figcaption>
</figure>

<figure>
  ![The action plan in Commons after the introduction of
  Commonplace.](./action-plan-after.png)(quality:100)
  <figcaption>
    **After.** The member action plan, early 2020. More information is available
    at a glance, without drilling down into cards and accordions.
  </figcaption>
</figure>
