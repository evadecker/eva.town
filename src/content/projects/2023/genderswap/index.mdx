...
To communicate the way these covers remix sound, reinterpret lyrics, and reconfigure meaning, I established a visual motif to thread its way through the app: two objects, overlapping and askew. Sharing space, but different. This is represented in the logo and the display of albums on the main grid.
...
As with all my work, I looked for opportunities to introduce small but meaningful details. Here are some of my favorite features I built for Genderswap.fm.
