...
There are many improvements I'd still love to make to the app. At the top of the list is an [in-app audio player](https://github.com/kydecker/genderswap.fm/issues/7). I'd also like [better search](https://github.com/kydecker/genderswap.fm/issues/133), and a way to [automatically generate and sync the Genderswap.fm database to a Spotify playlist](https://github.com/kydecker/genderswap.fm/issues/16). I track [all issues and ideas on GitHub](https://github.com/kydecker/genderswap.fm/issues), and contributions are welcome.
