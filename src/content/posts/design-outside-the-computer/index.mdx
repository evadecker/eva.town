...
I scanned in the cards using a flatbed scanner, cleaned up the images in Photoshop, and optimized them for web. Now now all these physical objects have a digital home. :)
...
Scanners are cheap nowadays, and produce much better results than photography.
