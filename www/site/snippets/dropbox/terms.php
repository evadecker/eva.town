<div class="post-callout">
  ...
  <ul class="emoji-list">
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f60e.png">
      <dl>
        <dt>Growth Platform</dt>
        <dd>my team, pictured above; buncha cool, nice nerds</dd>
      </dl>
    </li>
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f4e3.png">
      <dl>
        <dt>Megaphone</dt>
        <dd>the product suite created by Growth Platform; includes Bluemail, Bluenote, Prompt, and other utilities</dd>
      </dl>
    </li>
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f4e9.png">
      <dl>
        <dt>Bluemail</dt>
    ...
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f4f2.png">
      <dl>
        <dt>Bluenote</dt>
        <dd>like Bluemail, but for push notifications</dd>
      </dl>
    </li>
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f4b5.png">
      <dl>
        <dt>Prompt</dt>
    ...
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f6e4.png">
      <dl>
