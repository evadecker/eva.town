  ...
  <figure class="figure-wide wrapper">
    <div class="image-annotated">
      ...
      <div class="annotations">
        <div class="annotation rellax" style="top: 2%; left: 20%" data-direction="left" data-rellax-speed="-0.2">
        ...
        <div class="annotation rellax" style="top: 15%; left: 94%" data-direction="top-right" data-rellax-speed="-1">
        ...
        <div class="annotation rellax" style="top: 56%; left: 5.5%" data-direction="top-left" data-rellax-speed="-2">
