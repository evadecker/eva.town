  ...
  <figure class="figure-wide wrapper">
    <div class="image-annotated">
      ...
      <div class="annotations">
        ...
        <div class="annotation" style="top: 15%; left: 94%" data-direction="top-right">
          <div class="annotation-rellax">
        ...
        <div class="annotation" style="top: 56%; left: 5.5%" data-direction="top-left">
          <div class="annotation-rellax">
        ...
        <div class="annotation" style="top: 62%; left: 79%" data-direction="top">
          <div class="annotation-rellax">
