<figure>
  <picture>
    ...
    <img class="lazyload blur-up" data-src="<?= $page->image('dashboard-unified.png')->url() ?>" src="<?= $page->image('dashboard-unified.svg')->url() ?>" alt="A wireframe displays the Swiftype interface with sidebars for configuring display options.">
  </picture>
