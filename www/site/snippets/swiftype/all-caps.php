<div class="post-callout">
  ...
  <ul class="emoji-list">
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f629.png">
    ...
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f520.png">
      <strong>It can pose <a href="http://webaim.org/techniques/screenreader/">accessibility problems</a></strong> for vision-impaired users, whose screen readers may. read. one. letter. at. a. time.
    </li>
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f92c.png">
      <strong>IT FEELS <a href="https://youtu.be/IBO8c7v7guI?t=29">SHOUTY.</a></strong> Please stop yelling.
    </li>
    <li>
      <img class="emoji" src="<?= $site->url() ?>/assets/emoji/1f449.png">
