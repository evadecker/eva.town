<div class="encrypted-post">
  ...
  <div class="password-required">
    ...
    <form method="post">
      ...
      <?php if($error): ?>
        <div class="error-message">Incorrect passphrase. Please try again. Spaces are characters, too.</div>
      <?php endif ?>
      <div class="password-submit <?php if($error) echo 'try-again' ?>">
        <input class="password-submit" type="text" id="password" name="password" maxlength="48" placeholder="Enter the secret passphrase">
      </div>
      <input class="visually-hidden" type="submit" name="login" value="Go">
    </form>
  </div>
  <p class="garbled" aria-hidden="true">▘▙▗ ▚▟▖▟▜▂▘ ▙▗▚▂ ▟▗ ▟▜▘▙▗▚▟ ▟▜▘▜▂▘▙▗▚▘ ▟▟▘ ▜▂▘▙▚▟ ▟▜▘▘ ▙▗▂▚▟ ▟▙▗▚▟▟ ▜▖ ▘ ▙▗▂▙▗▚▟▖▟▙▗ ▚▟▟▜  ▗▚▟▟▖▟▜▘▙ ▟▜ ▘▗▚ ▟▟▜ ▘▜▘ ▙▗▚▂▚▟ ▟▜▗▘▙▗ ▚▟▟ ▖▜ ▖▘▙▂▗▚ ▟ ▗▟▚▟▟▜ ▚▟ ▟▜▘▙ ▗▚▚▟▘▗▗ ▙▗ ▚▟▂▟▜▘ ▟▜▖▘▙▗▚ ▘▙ ▗▚▟▖▟ ▟▗▜▘▙ ▗▂▚▙▗▚▟ ▙▘▙ ▗▟▜▘▗▙▗▂ ▚▟ ▟▟▜ ▘▙▟ ▖▟▜▟ ▟▜▘▙ ▗ ▚ ▟ ▟▜▘▙ ▗</p>
  <p class="garbled" aria-hidden="true">▚▟▟▜▘▘ ▙▗▂▚▟▟ ▙▗▚▟▟ ▜▖ ▘ ▙▗▂▙▗▚ ▟▖▟▙▗ ▚▟▟▜  ▗▚▟▟▖▟ ▜▘▙▟▜ ▘▗▚ ▟▟▜ ▘▜ ▘</p>
  <p class="garbled" aria-hidden="true">▙▗▚▟▖▟▙▗ ▚▟▟▜ ▜▂▘▙▗▚▘ ▟▟▘ ▜▂▘▙ ▗▚▟▟▖▟▜▘▙ ▟▜ ▘▙▘▙ ▗▂▚▟▟▜ ▗▘▙▗ ▚▟▟ ▖▜ ▖▘▙▂▗▚ ▟ ▗▟▚▟▟▜ ▚▟▟▜▘▘ ▙▗▂▚▟▟▜▖ ▘ ▙▗▂▚▟▟▜▘▙ ▗▚▟ ▟▜▘▙ ▗ ▚ ▟ ▟▜▘▙ ▗▚▟▘▗▗ ▙▗ ▚▟▂▟▜▘ ▟▜▖▘▙▗▚ ▘▙ ▗▚▟▖▟ ▟▗▜▘▙ ▗▂▚▙▗▚▟ ▟▜▘▙▗ ▚▟▟ ▖▜ ▖▘▙▂▗▚ ▟ ▗▟▚ ▟▟▜ ▚▟▟▜▘▘ ▙▗▂▚▟▟▜▖ ▘ ▙▗▂▚▟ ▟▜▘▙ ▗▚▟ ▟▜▘▙ ▗ ▚ ▟ ▟▜▘▙ ▗▚▟▘▗▗ ▙▗ ▚▟▂▟▜▘ ▟▜▖▘▙▗▚ ▘▙ ▗▚ ▟▖▟ ▟▗▜▘▙ ▗▂▚▙▗▚ ▟▟▜▘▗▙▗▂ ▚▟ ▟ ▟▜ ▘▙▗▚ ▟▟▜ ▘▙▗▚ ▟▟ ▜▘ ▙▗▚▟ ▖▟▜▘▙▗ ▚▟▖▟▜▂</p>
</div>
