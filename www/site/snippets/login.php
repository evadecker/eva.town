  ...
  <div class="password-required">
    ...
    <form method="post">
      ...
      <div class="password-submit <?php if($error) echo 'try-again' ?>">
        <?php if($error): ?>
          <div class="visually-hidden">Incorrect password. Please try again.</div>
        <?php endif ?>
        <input class="password-submit" type="text" id="password" name="password" placeholder="Enter the secret passphrase">
