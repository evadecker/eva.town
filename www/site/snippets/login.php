<aside class="post-callout password-required mobile-fullwidth">
  ...
  <p>I can’t share this project because laws. If you’re a recruiter or potential employer, grab the passphrase by emailing <a href="mailto:kyle@kyledecker.me">kyle@kyledecker.me</a>. Otherwise, please check out my openly available case studies for <a href="/work/swiftype">Swiftype</a> and <a href="/work/wintr-mx">Wintr.mx</a>.</p>
  <form method="post" <?php if($error) echo 'class="try-again"' ?>>
    ...
    <?php if($error): ?>
      <div class="error-message">Incorrect passphrase. Try again, and be sure to include spaces.</div>
    <?php endif ?>
