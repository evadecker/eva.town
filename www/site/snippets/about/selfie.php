<aside>
  <figure>
    ...
    <picture class="ratio-box" style="padding-top: 125%"> 
      ...
      <img class="lazyload blur-up" data-src="<?= $page->image('kyle-decker-portrait-sketch.png')->url() ?>" src="<?= $page->image('kyle-decker-portrait-sketch.svg')->url() ?>" alt="Portrait of the guy who made this site.">
    </picture>
