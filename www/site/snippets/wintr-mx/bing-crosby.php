<aside>
  <figure>
    <picture>
      ...
      <img class="lazyload blur-up" data-src="<?= $page->image('bing-crosby.jpg')->url() ?>" src="<?= $page->image('bing-crosby.svg')->url() ?>" alt='The record "White Christmas" by Bing Crosby, released in 1942.'>
    </picture>
