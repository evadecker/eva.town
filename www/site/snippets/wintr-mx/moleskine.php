<aside class="mobile-fullwidth">
  <figure>
    <picture>
      ...
      <img class="lazyload blur-up" data-src="<?= $page->image('transitions.png')->url() ?>" src="<?= $page->image('transitions.svg')->url() ?>" alt="A photo of a Moleskine notebook with written start and end keys of various songs.">
    </picture>
    <figcaption>
