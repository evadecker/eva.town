<div class="post-callout">
  ...
  <p>Music has no rules! But it does have conventions. Hover over the letter names on the circle of fifths to see common key changes between major keys.</p>
  ...
  <ul>
    ...
    <li><strong>Go <span class="color-halfstepdown">down a half-step</span>.</strong> Feels like sinking into a big, plush armchair. Relaxes tension.</li>
